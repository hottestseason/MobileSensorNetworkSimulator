...
//
//	public EvsmRobot(Integer id, Double wirelessRange, Double sensorRange, Double weight, Double size, Double iterateInterval) {
//		super(id, wirelessRange, sensorRange, weight, size, iterateInterval);
